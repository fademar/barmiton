                ...
                <div class="col-xs-12 col-md-12 ">
                    ...
                    <div class="svgbox hidden-xs">
                        <svg id="martini" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 65 100" preserveAspectRatio="xMinYMin meet">
                            ...
                            <path d="M49.21 17.5h-38c-1.46 0-2 1-1.15 2.21l18.65 27.17a1.71 1.71 0 0 0 3 0l18.65-27.17c.82-1.22.32-2.21-1.15-2.21z" fill="#49A1BC" opacity="0.7"/>

                            <path d="M28.49 29.45c-3.12 5.46-1.48 7.86 1.3 9.48s5.67 1.86 8.79-3.6 1.48-7.86-1.3-9.49-5.67-1.84-8.79 3.61z" fill="#bed630"/>

                            <path d="M28.49 29.45c-3.12 5.46-1.48 7.86 1.3 9.48s5.67 1.86 8.79-3.6 1.48-7.86-1.3-9.49-5.67-1.84-8.79 3.61z" fill="#49A1BC" opacity="0.2"/>
