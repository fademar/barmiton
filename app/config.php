...
$w_config = [
    ...
    'db_name' => 'barmiton',								//nom de la bdd
	...
	'security_login_route_name' => 'Users_UsersConnexion',			//nom de la route affichant le formulaire de connexion

	// configuration globale
	'site_name'	=> 'barmiton', 								// contiendra le nom du site
];
// Coucou les enculés
require('routes.php');
